package net.devmock.sshmock;

import net.devmock.common.CLISession;
...
//                    logger.info("session closed by quit");
//                    break;
//                } else if (s.contains("Efros CI test echo message")) {
//                    w.println("Efros CI test echo message");
//                } else {
